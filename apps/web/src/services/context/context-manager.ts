...
import type { AssistantId, Message, RoomId } from '@/types'
 ...
 */
export function setContextConfig(roomId: RoomId, config: Partial<ContextConfig>): void {
 ...
 */
export function getAssistantContext(roomId: RoomId, assistantId: AssistantId): Message[] {
