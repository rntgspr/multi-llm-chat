...
- ✅ Modelos TypeScript em `@synergy/types/db`
...
- [x] T003 [US1] ✅ Dependência `@synergy/db` configurada no monorepo
- [x] T004 [US1] ✅ Imports atualizados para usar `@synergy/db`
- [x] T005 [US1] ✅ `pnpm typecheck` passa nos packages do EPIC-001

**Checkpoint**: ✅ `@synergy/db` é a fonte única de verdade para persistência
