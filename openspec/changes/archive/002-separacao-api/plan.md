...
- `@synergy/platform` - Infraestrutura compartilhada (cliente Rediss, adaptadores de autenticação, cache, pub/sub, logging)
- `@synergy/db` - repositórios SurrealDB para armazenamento persistente
- `@synergy/types` - Tipos TypeScript compartilhados
- `@synergy/interaction` - Lógica de negócio para interações de chat
- `@synergy/interpretation` - Processamento de respostas LLM
...
- Shared: @synergy/db (SurrealDB 2.0.3), @synergy/platform (ioredis 5.4.1 for Redis Pub/Sub)
...
- 5 packages compartilhados: @synergy/db, @synergy/interaction, @synergy/interpretation, @synergy/platform, @synergy/types
