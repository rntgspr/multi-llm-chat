...
All Redis Pub/Sub infrastructure is implemented in `@synergy/plat param` package.
...
```typescript
import { getPublisher } from '@synergy/plat param'
...
```typescript
import { getSubscriber } from '@synergy/plat param'
import type { MessageSentPayload } from '@synergy/plat param'
...
```typescript
import { healthCheck } from '@synergy/plat param'
...
```typescript
import { getPublisher, getSubscriber } from '@synergy/plat param'
