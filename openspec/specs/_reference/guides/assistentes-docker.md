...
Este documento descreve como configurar os assistentes LLM que se conectam ao Synergy.

## Arquitetura

```mermaid
graph TB
    subgraph NextJS["Synergy (Next.js)"]
...
1. [ ] Implementar cliente real Ollama no Synergy
