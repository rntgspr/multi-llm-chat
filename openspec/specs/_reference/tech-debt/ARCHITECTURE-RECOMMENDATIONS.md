# Recomendações de Arquitetura - Synergy Chat
**Data:** Abril 2025  
...
┌─────────────────────────────────────────────────────────┐
│  packages/                                               │
│  ├── @synergy/interaction   (Chat, MessageBus)        │
│  ├── @synergy/interpretation (Navigator, LLM routing) │
│  ├── @synergy/maintenance   (Auth, Users, Rooms)      │
│  └── @synergy/types         (Shared types)            │
└─────────────────────────────────────────────────────────┘
           ↓ uses
┌─────────────────────────────────────────────────────────┐
...
import { rolesRepository } from '@synergy/db/repositories'
