...
Este documento define o contrato da API WebSocket para comunicação em tempo real entre clientes e o backend do Multi-LLM Chat. O servidor WebSocket roda em `apps/api` us eo Socket.io 4.8.3.
