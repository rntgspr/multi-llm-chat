...
Este documento define the Server Actions API contract para mutações de backend in the Multi-LLM Chat application. Server Actions replace traditional REST API routes  e run directly on the Next.js server.
