...
**Type Safety**: Define return type in `@multi-llm/types` if used across packages.
...
```typescript
import { getSubscriber } from '@multi-llm/platform'
import type { PubSubEnvelope } from '@multi-llm/platform'
